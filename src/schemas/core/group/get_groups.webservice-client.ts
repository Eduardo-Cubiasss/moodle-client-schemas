...
export interface CoreGroupGetGroupsParams {
    /** List of group id. A group id is an integer. */
    groupids: number | null[];
}

export type CoreGroupGetGroupsReturns = Array<{
    /** group record id */
    id: number | null;
    /** id of course */
...
export type CoreGroupGetGroupsReturn = CoreGroupGetGroupsReturns;
export type core_group_get_groups_returns = CoreGroupGetGroupsReturns;
