...
export interface CoreEnrolGetUsersCoursesParams {
    /** user id */
    userid: number | null;
...
export type CoreEnrolGetUsersCoursesReturns = Array<{
    /** id of course */
    id: number | null;
...
export type CoreEnrolGetUsersCoursesReturn = CoreEnrolGetUsersCoursesReturns;
export type core_enrol_get_users_courses_returns = CoreEnrolGetUsersCoursesReturns;
