...
export interface CoreEnrolSearchUsersParams {
    /** course id */
...
export type CoreEnrolSearchUsersReturns = Array<{
    /** ID of the user */
    id: number | null;
    /** The username */
...
export type CoreEnrolSearchUsersReturn = CoreEnrolSearchUsersReturns;
export type core_enrol_search_users_returns = CoreEnrolSearchUsersReturns;
