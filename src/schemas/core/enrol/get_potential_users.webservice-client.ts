...
export interface CoreEnrolGetPotentialUsersParams {
    /** course id */
...
export type CoreEnrolGetPotentialUsersReturns = Array<{
    /** ID of the user */
    id: number | null;
    /** The username */
...
export type CoreEnrolGetPotentialUsersReturn = CoreEnrolGetPotentialUsersReturns;
export type core_enrol_get_potential_users_returns = CoreEnrolGetPotentialUsersReturns;
