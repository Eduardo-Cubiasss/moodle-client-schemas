...
export interface CoreBlogAddEntryParams {
    /** Blog subject */
    subject: string | null;
    /** Blog post content */
    summary: string | null;
...
export interface CoreBlogAddEntryReturns {
    /** The new entry id. */
    entryid: number | null;
    /** list of warnings */
    warnings?: Array<{
...
export type CoreBlogAddEntryReturn = CoreBlogAddEntryReturns;
export type core_blog_add_entry_returns = CoreBlogAddEntryReturns;
