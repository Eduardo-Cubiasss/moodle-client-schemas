...
export interface CoreBlogUpdateEntryParams {
...
export interface CoreBlogUpdateEntryReturns {
...
export type CoreBlogUpdateEntryReturn = CoreBlogUpdateEntryReturns;
export type core_blog_update_entry_returns = CoreBlogUpdateEntryReturns;
