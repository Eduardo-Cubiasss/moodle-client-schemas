...
export interface CoreBadgesGetUserBadgesParams {
...
export interface CoreBadgesGetUserBadgesReturns {
    badges: Array<{
        /** Badge id */
        id?: number;
        /** Badge name */
...
export type CoreBadgesGetUserBadgesReturn = CoreBadgesGetUserBadgesReturns;
export type core_badges_get_user_badges_returns = CoreBadgesGetUserBadgesReturns;
