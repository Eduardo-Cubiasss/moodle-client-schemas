...
export interface CoreRoleAssignRolesParams {
    assignments: Array<{
...
export type CoreRoleAssignRolesReturns = unknown;

export type CoreRoleAssignRolesReturn = CoreRoleAssignRolesReturns;
export type core_role_assign_roles_returns = CoreRoleAssignRolesReturns;
