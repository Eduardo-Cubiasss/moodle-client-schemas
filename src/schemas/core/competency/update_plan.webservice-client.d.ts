...
export interface CoreCompetencyUpdatePlanParams {
    plan: {
        /** name */
        name?: string;
        /** description */
...
export interface CoreCompetencyUpdatePlanReturns {
    /** name */
    name: string;
    /** description */
    description: string;
...
export type CoreCompetencyUpdatePlanReturn = CoreCompetencyUpdatePlanReturns;
export type core_competency_update_plan_returns = CoreCompetencyUpdatePlanReturns;
