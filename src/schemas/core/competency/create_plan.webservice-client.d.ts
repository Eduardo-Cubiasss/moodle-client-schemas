...
export interface CoreCompetencyCreatePlanParams {
    plan: {
        /** name */
        name: string;
        /** description */
...
export interface CoreCompetencyCreatePlanReturns {
    /** name */
    name: string;
    /** description */
    description: string;
...
export type CoreCompetencyCreatePlanReturn = CoreCompetencyCreatePlanReturns;
export type core_competency_create_plan_returns = CoreCompetencyCreatePlanReturns;
