...
export interface CoreCompetencyReadPlanParams {
    /** Data base record id for the plan */
    id: number | null;
}

export interface CoreCompetencyReadPlanReturns {
    /** name */
    name: string;
    /** description */
    description: string;
...
export type CoreCompetencyReadPlanReturn = CoreCompetencyReadPlanReturns;
export type core_competency_read_plan_returns = CoreCompetencyReadPlanReturns;
