...
export interface CoreCompetencyListUserPlansParams {
    /** The user ID */
    userid: number | null;
}

export type CoreCompetencyListUserPlansReturns = Array<{
    /** name */
    name: string;
    /** description */
    description: string;
...
export type CoreCompetencyListUserPlansReturn = CoreCompetencyListUserPlansReturns;
export type core_competency_list_user_plans_returns = CoreCompetencyListUserPlansReturns;
