...
export interface CoreUpdateInplaceEditableParams {
...
export interface CoreUpdateInplaceEditableReturns {
...
export type CoreUpdateInplaceEditableReturn = CoreUpdateInplaceEditableReturns;
export type core_update_inplace_editable_returns = CoreUpdateInplaceEditableReturns;
