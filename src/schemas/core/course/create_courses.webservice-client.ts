/** Create new courses */
export interface CoreCourseCreateCoursesParams {
    /** courses to create */
    courses: Array<{
        /** full name */
...
export type CoreCourseCreateCoursesReturns = Array<{
    /** course id */
    id: number | null;
    /** short name */
    shortname: string | null;
...
export type CoreCourseCreateCoursesReturn = CoreCourseCreateCoursesReturns;
export type core_course_create_courses_returns = CoreCourseCreateCoursesReturns;
