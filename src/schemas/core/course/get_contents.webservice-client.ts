/** Get course contents */
export interface CoreCourseGetContentsParams {
    /** course id */
...
export type CoreCourseGetContentsReturns = Array<{
    /** Section ID */
    id: number | null;
    /** Section name */
    name: string | null;
...
export type CoreCourseGetContentsReturn = CoreCourseGetContentsReturns;
export type core_course_get_contents_returns = CoreCourseGetContentsReturns;
