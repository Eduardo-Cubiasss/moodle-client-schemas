...
export interface CoreCourseGetCourseModuleByInstanceParams {
    /** The module name */
    module: string | null;
...
export interface CoreCourseGetCourseModuleByInstanceReturns {
    cm: {
...
export type CoreCourseGetCourseModuleByInstanceReturn = CoreCourseGetCourseModuleByInstanceReturns;
export type core_course_get_course_module_by_instance_returns = CoreCourseGetCourseModuleByInstanceReturns;
