...
export interface CoreCourseGetCategoriesParams {
    /** criteria */
    criteria?: Array<{
...
export type CoreCourseGetCategoriesReturns = Array<{
    /** category id */
    id: number | null;
    /** category name */
    name: string | null;
...
export type CoreCourseGetCategoriesReturn = CoreCourseGetCategoriesReturns;
export type core_course_get_categories_returns = CoreCourseGetCategoriesReturns;
