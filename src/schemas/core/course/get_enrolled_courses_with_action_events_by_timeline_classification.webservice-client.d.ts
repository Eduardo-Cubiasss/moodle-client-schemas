...
export interface CoreCourseGetEnrolledCoursesWithActionEventsByTimelineClassificationParams {
...
export interface CoreCourseGetEnrolledCoursesWithActionEventsByTimelineClassificationReturns {
    /** Course */
    courses: Array<{
        /** id */
        id: number;
...
export type CoreCourseGetEnrolledCoursesWithActionEventsByTimelineClassificationReturn = CoreCourseGetEnrolledCoursesWithActionEventsByTimelineClassificationReturns;
export type core_course_get_enrolled_courses_with_action_events_by_timeline_classification_returns = CoreCourseGetEnrolledCoursesWithActionEventsByTimelineClassificationReturns;
