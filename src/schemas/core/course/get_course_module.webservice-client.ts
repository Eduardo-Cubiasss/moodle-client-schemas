...
export interface CoreCourseGetCourseModuleParams {
    /** The course module id */
    cmid: number | null;
}

export interface CoreCourseGetCourseModuleReturns {
    cm: {
        /** The course module id */
        id: number | null;
        /** The course id */
...
export type CoreCourseGetCourseModuleReturn = CoreCourseGetCourseModuleReturns;
export type core_course_get_course_module_returns = CoreCourseGetCourseModuleReturns;
