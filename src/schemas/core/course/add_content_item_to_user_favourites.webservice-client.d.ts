...
export interface CoreCourseAddContentItemToUserFavouritesParams {
...
export interface CoreCourseAddContentItemToUserFavouritesReturns {
...
export type CoreCourseAddContentItemToUserFavouritesReturn = CoreCourseAddContentItemToUserFavouritesReturns;
export type core_course_add_content_item_to_user_favourites_returns = CoreCourseAddContentItemToUserFavouritesReturns;
