...
export interface CoreTagGetTagCloudParams {
    /** Tag collection id. */
...
export interface CoreTagGetTagCloudReturns {
    tags: Array<{
        /** Tag name. */
        name: string | null;
...
export type CoreTagGetTagCloudReturn = CoreTagGetTagCloudReturns;
export type core_tag_get_tag_cloud_returns = CoreTagGetTagCloudReturns;
