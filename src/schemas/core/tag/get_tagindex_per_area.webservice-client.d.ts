...
export interface CoreTagGetTagindexPerAreaParams {
    /** parameters */
    tagindex: {
        /** tag id */
        id?: number | null;
...
export type CoreTagGetTagindexPerAreaReturns = Array<{
    /** tag id */
    tagid: number | null;
    /** tag area id */
    ta: number | null;
...
export type CoreTagGetTagindexPerAreaReturn = CoreTagGetTagindexPerAreaReturns;
export type core_tag_get_tagindex_per_area_returns = CoreTagGetTagindexPerAreaReturns;
