...
export interface CoreTagGetTagAreasParams {}

export interface CoreTagGetTagAreasReturns {
    areas: Array<{
        /** Area id. */
        id: number;
...
export type CoreTagGetTagAreasReturn = CoreTagGetTagAreasReturns;
export type core_tag_get_tag_areas_returns = CoreTagGetTagAreasReturns;
