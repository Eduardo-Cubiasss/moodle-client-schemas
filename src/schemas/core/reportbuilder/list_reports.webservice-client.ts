...
export interface CoreReportbuilderListReportsParams {
    /** Page number */
    page?: number | null;
    /** Reports per page */
    perpage?: number | null;
...
export interface CoreReportbuilderListReportsReturns {
    reports: Array<{
        /** name */
        name: string | null;
        /** source */
...
export type CoreReportbuilderListReportsReturn = CoreReportbuilderListReportsReturns;
export type core_reportbuilder_list_reports_returns = CoreReportbuilderListReportsReturns;
