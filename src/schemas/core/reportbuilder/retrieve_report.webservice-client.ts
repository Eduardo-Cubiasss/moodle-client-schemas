...
export interface CoreReportbuilderRetrieveReportParams {
    /** Report ID */
...
export interface CoreReportbuilderRetrieveReportReturns {
    details: {
        /** name */
        name: string | null;
        /** source */
...
export type CoreReportbuilderRetrieveReportReturn = CoreReportbuilderRetrieveReportReturns;
export type core_reportbuilder_retrieve_report_returns = CoreReportbuilderRetrieveReportReturns;
