...
export interface CoreCalendarGetCalendarMonthlyViewParams {
    /** Year to be viewed */
    year: number | null;
    /** Month to be viewed */
    month: number | null;
...
export interface CoreCalendarGetCalendarMonthlyViewReturns {
    /** url */
    url: string;
    /** courseid */
    courseid: number;
...
export type CoreCalendarGetCalendarMonthlyViewReturn = CoreCalendarGetCalendarMonthlyViewReturns;
export type core_calendar_get_calendar_monthly_view_returns = CoreCalendarGetCalendarMonthlyViewReturns;
