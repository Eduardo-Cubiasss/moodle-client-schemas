...
export interface CoreCalendarGetActionEventsByCoursesParams {
...
export interface CoreCalendarGetActionEventsByCoursesReturns {
    /** groupedbycourse */
...
export type CoreCalendarGetActionEventsByCoursesReturn = CoreCalendarGetActionEventsByCoursesReturns;
export type core_calendar_get_action_events_by_courses_returns = CoreCalendarGetActionEventsByCoursesReturns;
