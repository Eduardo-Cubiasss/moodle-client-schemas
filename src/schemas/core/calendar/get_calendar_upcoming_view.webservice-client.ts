...
export interface CoreCalendarGetCalendarUpcomingViewParams {
    /** Course being viewed */
...
export interface CoreCalendarGetCalendarUpcomingViewReturns {
    /** events */
    events: Array<{
        /** id */
        id: number;
...
export type CoreCalendarGetCalendarUpcomingViewReturn = CoreCalendarGetCalendarUpcomingViewReturns;
export type core_calendar_get_calendar_upcoming_view_returns = CoreCalendarGetCalendarUpcomingViewReturns;
