...
export interface CoreCalendarGetActionEventsByTimesortParams {
    /** Time sort from */
...
export interface CoreCalendarGetActionEventsByTimesortReturns {
    /** events */
    events: Array<{
        /** id */
        id: number;
...
export type CoreCalendarGetActionEventsByTimesortReturn = CoreCalendarGetActionEventsByTimesortReturns;
export type core_calendar_get_action_events_by_timesort_returns = CoreCalendarGetActionEventsByTimesortReturns;
