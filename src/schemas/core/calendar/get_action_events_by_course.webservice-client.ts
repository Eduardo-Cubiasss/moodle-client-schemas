...
export interface CoreCalendarGetActionEventsByCourseParams {
    /** Course id */
...
export interface CoreCalendarGetActionEventsByCourseReturns {
    /** events */
    events: Array<{
        /** id */
        id: number;
...
export type CoreCalendarGetActionEventsByCourseReturn = CoreCalendarGetActionEventsByCourseReturns;
export type core_calendar_get_action_events_by_course_returns = CoreCalendarGetActionEventsByCourseReturns;
