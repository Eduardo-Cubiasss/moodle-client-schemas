...
export interface CoreMessageGetMemberInfoParams {
    /** id of the user */
...
export type CoreMessageGetMemberInfoReturns = Array<{
    /** The user id */
    id: number | null;
    /** The user's name */
...
export type CoreMessageGetMemberInfoReturn = CoreMessageGetMemberInfoReturns;
export type core_message_get_member_info_returns = CoreMessageGetMemberInfoReturns;
