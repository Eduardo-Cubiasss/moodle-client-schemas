...
export interface CoreMessageGetUserContactsParams {
...
export type CoreMessageGetUserContactsReturns = Array<{
    /** The user id */
    id: number | null;
    /** The user's name */
...
export type CoreMessageGetUserContactsReturn = CoreMessageGetUserContactsReturns;
export type core_message_get_user_contacts_returns = CoreMessageGetUserContactsReturns;
