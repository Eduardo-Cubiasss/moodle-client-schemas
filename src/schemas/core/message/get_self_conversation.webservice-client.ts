...
export interface CoreMessageGetSelfConversationParams {
...
export interface CoreMessageGetSelfConversationReturns {
    /** The conversation id */
    id: number | null;
...
export type CoreMessageGetSelfConversationReturn = CoreMessageGetSelfConversationReturns;
export type core_message_get_self_conversation_returns = CoreMessageGetSelfConversationReturns;
