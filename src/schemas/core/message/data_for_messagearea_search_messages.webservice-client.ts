...
export interface CoreMessageDataForMessageareaSearchMessagesParams {
...
export interface CoreMessageDataForMessageareaSearchMessagesReturns {
    contacts: Array<{
        /** The user's id */
        userid: number | null;
        /** The user's name */
...
export type CoreMessageDataForMessageareaSearchMessagesReturn = CoreMessageDataForMessageareaSearchMessagesReturns;
export type core_message_data_for_messagearea_search_messages_returns = CoreMessageDataForMessageareaSearchMessagesReturns;
