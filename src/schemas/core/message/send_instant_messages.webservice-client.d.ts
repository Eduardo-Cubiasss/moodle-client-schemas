...
export interface CoreMessageSendInstantMessagesParams {
    messages: Array<{
...
export type CoreMessageSendInstantMessagesReturns = Array<{
...
export type CoreMessageSendInstantMessagesReturn = CoreMessageSendInstantMessagesReturns;
export type core_message_send_instant_messages_returns = CoreMessageSendInstantMessagesReturns;
