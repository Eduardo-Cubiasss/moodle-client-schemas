...
export interface CoreMessageGetMessagesParams {
...
export interface CoreMessageGetMessagesReturns {
    messages: Array<{
        /** Message id */
        id: number | null;
        /** User from id */
...
export type CoreMessageGetMessagesReturn = CoreMessageGetMessagesReturns;
export type core_message_get_messages_returns = CoreMessageGetMessagesReturns;
