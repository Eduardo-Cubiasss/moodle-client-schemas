...
export interface CoreMessageGetConversationsParams {
...
export interface CoreMessageGetConversationsReturns {
    conversations: Array<{
        /** The conversation id */
        id: number | null;
...
export type CoreMessageGetConversationsReturn = CoreMessageGetConversationsReturns;
export type core_message_get_conversations_returns = CoreMessageGetConversationsReturns;
