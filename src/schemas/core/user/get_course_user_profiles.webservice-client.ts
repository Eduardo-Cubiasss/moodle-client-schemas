...
export interface CoreUserGetCourseUserProfilesParams {
    userlist: Array<{
        /** userid */
        userid: number | null;
        /** courseid */
...
export type CoreUserGetCourseUserProfilesReturns = Array<{
    /** ID of the user */
    id: number | null;
    /** The username */
...
export type CoreUserGetCourseUserProfilesReturn = CoreUserGetCourseUserProfilesReturns;
export type core_user_get_course_user_profiles_returns = CoreUserGetCourseUserProfilesReturns;
