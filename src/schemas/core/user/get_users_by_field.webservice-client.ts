export interface CoreUserGetUsersByFieldParams {
    /** the search field can be 'id' or 'idnumber' or 'username' or 'email' */
    field: string | null;
    values: string | null[];
}

export type CoreUserGetUsersByFieldReturns = Array<{
    /** ID of the user */
    id: number | null;
    /** The username */
...
export type CoreUserGetUsersByFieldReturn = CoreUserGetUsersByFieldReturns;
export type core_user_get_users_by_field_returns = CoreUserGetUsersByFieldReturns;
