/** Create users. */
export interface CoreUserCreateUsersParams {
    users: Array<{
...
export type CoreUserCreateUsersReturns = Array<{
    /** user id */
    id: number | null;
    /** user name */
    username: string | null;
...
export type CoreUserCreateUsersReturn = CoreUserCreateUsersReturns;
export type core_user_create_users_returns = CoreUserCreateUsersReturns;
