/** Update users. */
export interface CoreUserUpdateUsersParams {
    users: Array<{
        /** ID of the user */
        id: number | null;
...
export interface CoreUserUpdateUsersReturns {
    /** list of warnings */
    warnings?: Array<{
        /** item */
        item?: string | null;
...
export type CoreUserUpdateUsersReturn = CoreUserUpdateUsersReturns;
export type core_user_update_users_returns = CoreUserUpdateUsersReturns;
