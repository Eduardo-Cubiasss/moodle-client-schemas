/** Create notes */
export interface CoreNotesCreateNotesParams {
    notes: Array<{
...
export type CoreNotesCreateNotesReturns = Array<{
...
export type CoreNotesCreateNotesReturn = CoreNotesCreateNotesReturns;
export type core_notes_create_notes_returns = CoreNotesCreateNotesReturns;
