...
export interface CoreGradesGraderGradingpanelScaleStoreParams {
...
export interface CoreGradesGraderGradingpanelScaleStoreReturns {
...
export type CoreGradesGraderGradingpanelScaleStoreReturn = CoreGradesGraderGradingpanelScaleStoreReturns;
export type core_grades_grader_gradingpanel_scale_store_returns = CoreGradesGraderGradingpanelScaleStoreReturns;
