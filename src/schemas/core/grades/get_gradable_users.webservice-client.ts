...
export interface CoreGradesGetGradableUsersParams {
    /** Course Id */
...
export interface CoreGradesGetGradableUsersReturns {
    users: Array<{
        /** ID of the user */
        id: number | null;
        /** The username */
...
export type CoreGradesGetGradableUsersReturn = CoreGradesGetGradableUsersReturns;
export type core_grades_get_gradable_users_returns = CoreGradesGetGradableUsersReturns;
