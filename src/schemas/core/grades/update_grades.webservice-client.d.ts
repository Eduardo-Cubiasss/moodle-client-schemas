...
export interface CoreGradesUpdateGradesParams {
...
export type CoreGradesUpdateGradesReturns = number | null;

export type CoreGradesUpdateGradesReturn = CoreGradesUpdateGradesReturns;
export type core_grades_update_grades_returns = CoreGradesUpdateGradesReturns;
