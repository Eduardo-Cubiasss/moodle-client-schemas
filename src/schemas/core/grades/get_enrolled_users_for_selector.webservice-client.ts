...
export interface CoreGradesGetEnrolledUsersForSelectorParams {
    /** Course Id */
...
export interface CoreGradesGetEnrolledUsersForSelectorReturns {
    users: Array<{
        /** ID of the user */
        id: number | null;
        /** The username */
...
export type CoreGradesGetEnrolledUsersForSelectorReturn = CoreGradesGetEnrolledUsersForSelectorReturns;
export type core_grades_get_enrolled_users_for_selector_returns = CoreGradesGetEnrolledUsersForSelectorReturns;
