...
export interface ToolLpDataForUserEvidenceListPageParams {
    /** The user ID */
    userid: number | null;
}

export interface ToolLpDataForUserEvidenceListPageReturns {
...
export type ToolLpDataForUserEvidenceListPageReturn = ToolLpDataForUserEvidenceListPageReturns;
export type tool_lp_data_for_user_evidence_list_page_returns = ToolLpDataForUserEvidenceListPageReturns;
