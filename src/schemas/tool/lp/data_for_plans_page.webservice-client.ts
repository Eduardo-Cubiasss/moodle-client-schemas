...
export interface ToolLpDataForPlansPageParams {
    /** The user id */
    userid: number | null;
}

export interface ToolLpDataForPlansPageReturns {
...
export type ToolLpDataForPlansPageReturn = ToolLpDataForPlansPageReturns;
export type tool_lp_data_for_plans_page_returns = ToolLpDataForPlansPageReturns;
