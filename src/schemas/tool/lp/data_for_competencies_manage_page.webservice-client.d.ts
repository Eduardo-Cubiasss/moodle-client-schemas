...
export interface ToolLpDataForCompetenciesManagePageParams {
...
export interface ToolLpDataForCompetenciesManagePageReturns {
    framework: {
        /** shortname */
        shortname: string;
        /** idnumber */
...
export type ToolLpDataForCompetenciesManagePageReturn = ToolLpDataForCompetenciesManagePageReturns;
export type tool_lp_data_for_competencies_manage_page_returns = ToolLpDataForCompetenciesManagePageReturns;
