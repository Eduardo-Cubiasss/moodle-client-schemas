...
export interface ToolMobileGetPublicConfigParams {}

export interface ToolMobileGetPublicConfigReturns {
    /** Site URL. */
    wwwroot: string | null;
...
export type ToolMobileGetPublicConfigReturn = ToolMobileGetPublicConfigReturns;
export type tool_mobile_get_public_config_returns = ToolMobileGetPublicConfigReturns;
