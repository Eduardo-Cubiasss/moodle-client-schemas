...
export interface MessagePopupGetPopupNotificationsParams {
...
export interface MessagePopupGetPopupNotificationsReturns {
    notifications: Array<{
...
export type MessagePopupGetPopupNotificationsReturn = MessagePopupGetPopupNotificationsReturns;
export type message_popup_get_popup_notifications_returns = MessagePopupGetPopupNotificationsReturns;
