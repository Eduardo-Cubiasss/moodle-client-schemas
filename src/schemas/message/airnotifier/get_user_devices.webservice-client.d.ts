...
export interface MessageAirnotifierGetUserDevicesParams {
...
export interface MessageAirnotifierGetUserDevicesReturns {
    /** List of devices */
    devices: Array<{
...
export type MessageAirnotifierGetUserDevicesReturn = MessageAirnotifierGetUserDevicesReturns;
export type message_airnotifier_get_user_devices_returns = MessageAirnotifierGetUserDevicesReturns;
