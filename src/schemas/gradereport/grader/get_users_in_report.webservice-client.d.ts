...
export interface GradereportGraderGetUsersInReportParams {
    /** Course ID */
    courseid: number | null;
}

export interface GradereportGraderGetUsersInReportReturns {
    users: Array<{
        /** ID of the user */
        id: number | null;
        /** The username */
...
export type GradereportGraderGetUsersInReportReturn = GradereportGraderGetUsersInReportReturns;
export type gradereport_grader_get_users_in_report_returns = GradereportGraderGetUsersInReportReturns;
