...
export interface ModLtiGetLtisByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModLtiGetLtisByCoursesReturns {
    ltis: Array<{
...
export type ModLtiGetLtisByCoursesReturn = ModLtiGetLtisByCoursesReturns;
export type mod_lti_get_ltis_by_courses_returns = ModLtiGetLtisByCoursesReturns;
