...
export interface ModChatGetChatsByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModChatGetChatsByCoursesReturns {
    chats: Array<{
...
export type ModChatGetChatsByCoursesReturn = ModChatGetChatsByCoursesReturns;
export type mod_chat_get_chats_by_courses_returns = ModChatGetChatsByCoursesReturns;
