...
export interface ModAssignGetParticipantParams {
    /** assign instance id */
...
export interface ModAssignGetParticipantReturns {
    /** ID of the user */
    id: number | null;
...
export type ModAssignGetParticipantReturn = ModAssignGetParticipantReturns;
export type mod_assign_get_participant_returns = ModAssignGetParticipantReturns;
