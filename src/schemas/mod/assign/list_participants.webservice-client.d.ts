...
export interface ModAssignListParticipantsParams {
    /** assign instance id */
...
export type ModAssignListParticipantsReturns = Array<{
    /** ID of the user */
    id: number | null;
    /** The username */
...
export type ModAssignListParticipantsReturn = ModAssignListParticipantsReturns;
export type mod_assign_list_participants_returns = ModAssignListParticipantsReturns;
