...
export interface ModLessonGetContentPagesViewedParams {
    /** lesson instance id */
...
export interface ModLessonGetContentPagesViewedReturns {
    pages: Array<{
        /** The attempt id. */
        id: number | null;
        /** The lesson id. */
...
export type ModLessonGetContentPagesViewedReturn = ModLessonGetContentPagesViewedReturns;
export type mod_lesson_get_content_pages_viewed_returns = ModLessonGetContentPagesViewedReturns;
