...
export interface ModLessonGetLessonParams {
    /** lesson instance id */
...
export interface ModLessonGetLessonReturns {
    lesson: {
...
export type ModLessonGetLessonReturn = ModLessonGetLessonReturns;
export type mod_lesson_get_lesson_returns = ModLessonGetLessonReturns;
