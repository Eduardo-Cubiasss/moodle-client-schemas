...
export interface ModLessonGetLessonsByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModLessonGetLessonsByCoursesReturns {
    lessons: Array<{
...
export type ModLessonGetLessonsByCoursesReturn = ModLessonGetLessonsByCoursesReturns;
export type mod_lesson_get_lessons_by_courses_returns = ModLessonGetLessonsByCoursesReturns;
