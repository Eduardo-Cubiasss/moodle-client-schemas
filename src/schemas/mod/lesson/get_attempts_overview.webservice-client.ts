...
export interface ModLessonGetAttemptsOverviewParams {
    /** lesson instance id */
...
export interface ModLessonGetAttemptsOverviewReturns {
...
export type ModLessonGetAttemptsOverviewReturn = ModLessonGetAttemptsOverviewReturns;
export type mod_lesson_get_attempts_overview_returns = ModLessonGetAttemptsOverviewReturns;
