...
export interface ModLessonGetPageDataParams {
    /** lesson instance id */
...
export interface ModLessonGetPageDataReturns {
    /** Page fields */
    page?: {
...
export type ModLessonGetPageDataReturn = ModLessonGetPageDataReturns;
export type mod_lesson_get_page_data_returns = ModLessonGetPageDataReturns;
