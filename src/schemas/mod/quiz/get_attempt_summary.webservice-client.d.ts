...
export interface ModQuizGetAttemptSummaryParams {
    /** attempt id */
...
export interface ModQuizGetAttemptSummaryReturns {
    questions: Array<{
        /** slot number */
        slot: number | null;
...
export type ModQuizGetAttemptSummaryReturn = ModQuizGetAttemptSummaryReturns;
export type mod_quiz_get_attempt_summary_returns = ModQuizGetAttemptSummaryReturns;
