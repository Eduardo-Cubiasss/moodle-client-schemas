...
export interface ModQuizGetQuizzesByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModQuizGetQuizzesByCoursesReturns {
    quizzes: Array<{
...
export type ModQuizGetQuizzesByCoursesReturn = ModQuizGetQuizzesByCoursesReturns;
export type mod_quiz_get_quizzes_by_courses_returns = ModQuizGetQuizzesByCoursesReturns;
