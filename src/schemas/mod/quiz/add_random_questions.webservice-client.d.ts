...
export interface ModQuizAddRandomQuestionsParams {
...
export interface ModQuizAddRandomQuestionsReturns {
    /** Message */
    message?: string | null;
}

export type ModQuizAddRandomQuestionsReturn = ModQuizAddRandomQuestionsReturns;
export type mod_quiz_add_random_questions_returns = ModQuizAddRandomQuestionsReturns;
