...
export interface ModQuizGetAttemptDataParams {
    /** attempt id */
...
export interface ModQuizGetAttemptDataReturns {
    attempt: {
        /** Attempt id. */
        id?: number | null;
...
export type ModQuizGetAttemptDataReturn = ModQuizGetAttemptDataReturns;
export type mod_quiz_get_attempt_data_returns = ModQuizGetAttemptDataReturns;
