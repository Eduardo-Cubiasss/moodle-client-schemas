...
export interface ModPageGetPagesByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModPageGetPagesByCoursesReturns {
    pages: Array<{
...
export type ModPageGetPagesByCoursesReturn = ModPageGetPagesByCoursesReturns;
export type mod_page_get_pages_by_courses_returns = ModPageGetPagesByCoursesReturns;
