...
export interface ModWikiNewPageParams {
    /** New page title. */
    title: string | null;
    /** Page contents. */
    content: string | null;
...
export interface ModWikiNewPageReturns {
    /** New page id. */
    pageid: number | null;
    /** list of warnings */
    warnings?: Array<{
...
export type ModWikiNewPageReturn = ModWikiNewPageReturns;
export type mod_wiki_new_page_returns = ModWikiNewPageReturns;
