...
export interface ModWikiGetPageContentsParams {
    /** Page ID. */
    pageid: number | null;
}

export interface ModWikiGetPageContentsReturns {
    /** Page */
    page: {
        /** Page ID. */
        id: number | null;
...
export type ModWikiGetPageContentsReturn = ModWikiGetPageContentsReturns;
export type mod_wiki_get_page_contents_returns = ModWikiGetPageContentsReturns;
