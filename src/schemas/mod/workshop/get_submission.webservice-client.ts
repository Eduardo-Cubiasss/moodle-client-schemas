...
export interface ModWorkshopGetSubmissionParams {
    /** Submission id */
    submissionid: number | null;
}

export interface ModWorkshopGetSubmissionReturns {
    submission: {
...
export type ModWorkshopGetSubmissionReturn = ModWorkshopGetSubmissionReturns;
export type mod_workshop_get_submission_returns = ModWorkshopGetSubmissionReturns;
