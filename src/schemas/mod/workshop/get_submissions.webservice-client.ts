...
export interface ModWorkshopGetSubmissionsParams {
...
export interface ModWorkshopGetSubmissionsReturns {
    submissions: Array<{
...
export type ModWorkshopGetSubmissionsReturn = ModWorkshopGetSubmissionsReturns;
export type mod_workshop_get_submissions_returns = ModWorkshopGetSubmissionsReturns;
