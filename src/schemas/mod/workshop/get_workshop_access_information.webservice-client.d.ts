...
export interface ModWorkshopGetWorkshopAccessInformationParams {
    /** Workshop instance id. */
    workshopid: number | null;
}

export interface ModWorkshopGetWorkshopAccessInformationReturns {
...
export type ModWorkshopGetWorkshopAccessInformationReturn = ModWorkshopGetWorkshopAccessInformationReturns;
export type mod_workshop_get_workshop_access_information_returns = ModWorkshopGetWorkshopAccessInformationReturns;
