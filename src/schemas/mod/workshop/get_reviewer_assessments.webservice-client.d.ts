...
export interface ModWorkshopGetReviewerAssessmentsParams {
...
export interface ModWorkshopGetReviewerAssessmentsReturns {
    assessments: Array<{
...
export type ModWorkshopGetReviewerAssessmentsReturn = ModWorkshopGetReviewerAssessmentsReturns;
export type mod_workshop_get_reviewer_assessments_returns = ModWorkshopGetReviewerAssessmentsReturns;
