...
export interface ModWorkshopGetAssessmentParams {
    /** Assessment id */
    assessmentid: number | null;
}

export interface ModWorkshopGetAssessmentReturns {
    assessment: {
...
export type ModWorkshopGetAssessmentReturn = ModWorkshopGetAssessmentReturns;
export type mod_workshop_get_assessment_returns = ModWorkshopGetAssessmentReturns;
