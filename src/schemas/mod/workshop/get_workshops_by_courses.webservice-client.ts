...
export interface ModWorkshopGetWorkshopsByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModWorkshopGetWorkshopsByCoursesReturns {
    workshops: Array<{
...
export type ModWorkshopGetWorkshopsByCoursesReturn = ModWorkshopGetWorkshopsByCoursesReturns;
export type mod_workshop_get_workshops_by_courses_returns = ModWorkshopGetWorkshopsByCoursesReturns;
