...
export interface ModWorkshopGetSubmissionAssessmentsParams {
    /** Submission id */
    submissionid: number | null;
}

export interface ModWorkshopGetSubmissionAssessmentsReturns {
    assessments: Array<{
...
export type ModWorkshopGetSubmissionAssessmentsReturn = ModWorkshopGetSubmissionAssessmentsReturns;
export type mod_workshop_get_submission_assessments_returns = ModWorkshopGetSubmissionAssessmentsReturns;
