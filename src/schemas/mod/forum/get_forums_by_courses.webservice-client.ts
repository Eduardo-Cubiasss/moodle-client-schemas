...
export interface ModForumGetForumsByCoursesParams {
    /** Array of Course IDs */
    courseids?: number[];
}

export type ModForumGetForumsByCoursesReturns = Array<{
    /** Forum id */
    id: number | null;
    /** Course id */
    course: number | null;
...
export type ModForumGetForumsByCoursesReturn = ModForumGetForumsByCoursesReturns;
export type mod_forum_get_forums_by_courses_returns = ModForumGetForumsByCoursesReturns;
