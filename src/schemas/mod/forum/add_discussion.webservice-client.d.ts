...
export interface ModForumAddDiscussionParams {
    /** Forum instance ID */
    forumid: number | null;
...
export interface ModForumAddDiscussionReturns {
    /** New Discussion ID */
...
export type ModForumAddDiscussionReturn = ModForumAddDiscussionReturns;
export type mod_forum_add_discussion_returns = ModForumAddDiscussionReturns;
