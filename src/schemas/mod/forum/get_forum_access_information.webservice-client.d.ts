...
export interface ModForumGetForumAccessInformationParams {
    /** Forum instance id. */
    forumid: number | null;
}

export interface ModForumGetForumAccessInformationReturns {
    /** list of warnings */
    warnings?: Array<{
        /** item */
        item?: string | null;
...
export type ModForumGetForumAccessInformationReturn = ModForumGetForumAccessInformationReturns;
export type mod_forum_get_forum_access_information_returns = ModForumGetForumAccessInformationReturns;
