...
export interface ModForumGetForumDiscussionsParams {
    /** forum instance id */
    forumid: number | null;
...
export interface ModForumGetForumDiscussionsReturns {
    discussions: Array<{
        /** Post id */
        id: number | null;
        /** Discussion name */
...
export type ModForumGetForumDiscussionsReturn = ModForumGetForumDiscussionsReturns;
export type mod_forum_get_forum_discussions_returns = ModForumGetForumDiscussionsReturns;
