...
export interface ModDataGetEntryParams {
    /** record entry id */
    entryid: number | null;
...
export interface ModDataGetEntryReturns {
    entry: {
        /** Record id. */
        id: number;
...
export type ModDataGetEntryReturn = ModDataGetEntryReturns;
export type mod_data_get_entry_returns = ModDataGetEntryReturns;
