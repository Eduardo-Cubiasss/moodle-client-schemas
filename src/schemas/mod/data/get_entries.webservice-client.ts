...
export interface ModDataGetEntriesParams {
    /** data instance id */
...
export interface ModDataGetEntriesReturns {
    entries: Array<{
        /** Record id. */
        id: number;
...
export type ModDataGetEntriesReturn = ModDataGetEntriesReturns;
export type mod_data_get_entries_returns = ModDataGetEntriesReturns;
