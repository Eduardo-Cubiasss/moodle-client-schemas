...
export interface ModGlossaryGetEntriesByLetterParams {
    /** Glossary entry ID */
    id: number | null;
...
export interface ModGlossaryGetEntriesByLetterReturns {
...
export type ModGlossaryGetEntriesByLetterReturn = ModGlossaryGetEntriesByLetterReturns;
export type mod_glossary_get_entries_by_letter_returns = ModGlossaryGetEntriesByLetterReturns;
