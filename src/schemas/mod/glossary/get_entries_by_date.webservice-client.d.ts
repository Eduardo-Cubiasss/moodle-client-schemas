...
export interface ModGlossaryGetEntriesByDateParams {
    /** Glossary entry ID */
    id: number | null;
...
export interface ModGlossaryGetEntriesByDateReturns {
...
export type ModGlossaryGetEntriesByDateReturn = ModGlossaryGetEntriesByDateReturns;
export type mod_glossary_get_entries_by_date_returns = ModGlossaryGetEntriesByDateReturns;
