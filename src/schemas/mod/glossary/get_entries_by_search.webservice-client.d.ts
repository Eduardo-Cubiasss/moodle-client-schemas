...
export interface ModGlossaryGetEntriesBySearchParams {
    /** Glossary entry ID */
    id: number | null;
    /** The query string */
    query: string | null;
...
export interface ModGlossaryGetEntriesBySearchReturns {
...
export type ModGlossaryGetEntriesBySearchReturn = ModGlossaryGetEntriesBySearchReturns;
export type mod_glossary_get_entries_by_search_returns = ModGlossaryGetEntriesBySearchReturns;
