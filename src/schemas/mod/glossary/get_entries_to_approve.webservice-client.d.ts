...
export interface ModGlossaryGetEntriesToApproveParams {
    /** Glossary entry ID */
    id: number | null;
...
export interface ModGlossaryGetEntriesToApproveReturns {
...
export type ModGlossaryGetEntriesToApproveReturn = ModGlossaryGetEntriesToApproveReturns;
export type mod_glossary_get_entries_to_approve_returns = ModGlossaryGetEntriesToApproveReturns;
