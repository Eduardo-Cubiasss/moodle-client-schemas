...
export interface ModGlossaryGetGlossariesByCoursesParams {
    /** Array of course IDs */
    courseids?: number | null[];
}

export interface ModGlossaryGetGlossariesByCoursesReturns {
    glossaries: Array<{
...
export type ModGlossaryGetGlossariesByCoursesReturn = ModGlossaryGetGlossariesByCoursesReturns;
export type mod_glossary_get_glossaries_by_courses_returns = ModGlossaryGetGlossariesByCoursesReturns;
