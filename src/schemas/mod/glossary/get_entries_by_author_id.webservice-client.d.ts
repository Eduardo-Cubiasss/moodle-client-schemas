...
export interface ModGlossaryGetEntriesByAuthorIdParams {
    /** Glossary entry ID */
    id: number | null;
    /** The author ID */
...
export interface ModGlossaryGetEntriesByAuthorIdReturns {
...
export type ModGlossaryGetEntriesByAuthorIdReturn = ModGlossaryGetEntriesByAuthorIdReturns;
export type mod_glossary_get_entries_by_author_id_returns = ModGlossaryGetEntriesByAuthorIdReturns;
