...
export interface ModGlossaryUpdateEntryParams {
...
export interface ModGlossaryUpdateEntryReturns {
    /** The update result */
    result: boolean | null;
    /** list of warnings */
    warnings?: Array<{
...
export type ModGlossaryUpdateEntryReturn = ModGlossaryUpdateEntryReturns;
export type mod_glossary_update_entry_returns = ModGlossaryUpdateEntryReturns;
