...
export interface ModGlossaryGetEntriesByTermParams {
    /** Glossary entry ID */
    id: number | null;
...
export interface ModGlossaryGetEntriesByTermReturns {
...
export type ModGlossaryGetEntriesByTermReturn = ModGlossaryGetEntriesByTermReturns;
export type mod_glossary_get_entries_by_term_returns = ModGlossaryGetEntriesByTermReturns;
