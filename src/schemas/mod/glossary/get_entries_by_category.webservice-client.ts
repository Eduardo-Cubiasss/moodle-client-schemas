...
export interface ModGlossaryGetEntriesByCategoryParams {
    /** The glossary ID. */
    id: number | null;
...
export interface ModGlossaryGetEntriesByCategoryReturns {
...
export type ModGlossaryGetEntriesByCategoryReturn = ModGlossaryGetEntriesByCategoryReturns;
export type mod_glossary_get_entries_by_category_returns = ModGlossaryGetEntriesByCategoryReturns;
