...
export interface ModGlossaryAddEntryParams {
    /** Glossary id */
...
export interface ModGlossaryAddEntryReturns {
...
export type ModGlossaryAddEntryReturn = ModGlossaryAddEntryReturns;
export type mod_glossary_add_entry_returns = ModGlossaryAddEntryReturns;
