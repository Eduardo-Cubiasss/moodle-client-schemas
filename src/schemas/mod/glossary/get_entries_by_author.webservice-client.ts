...
export interface ModGlossaryGetEntriesByAuthorParams {
    /** Glossary entry ID */
    id: number | null;
...
export interface ModGlossaryGetEntriesByAuthorReturns {
...
export type ModGlossaryGetEntriesByAuthorReturn = ModGlossaryGetEntriesByAuthorReturns;
export type mod_glossary_get_entries_by_author_returns = ModGlossaryGetEntriesByAuthorReturns;
