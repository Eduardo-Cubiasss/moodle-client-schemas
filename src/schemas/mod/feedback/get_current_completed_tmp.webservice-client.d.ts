...
export interface ModFeedbackGetCurrentCompletedTmpParams {
...
export interface ModFeedbackGetCurrentCompletedTmpReturns {
    feedback: {
        /** The record id. */
        id: number;
...
export type ModFeedbackGetCurrentCompletedTmpReturn = ModFeedbackGetCurrentCompletedTmpReturns;
export type mod_feedback_get_current_completed_tmp_returns = ModFeedbackGetCurrentCompletedTmpReturns;
