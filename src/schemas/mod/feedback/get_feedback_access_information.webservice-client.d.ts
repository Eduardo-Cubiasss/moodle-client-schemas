...
export interface ModFeedbackGetFeedbackAccessInformationParams {
...
export interface ModFeedbackGetFeedbackAccessInformationReturns {
...
export type ModFeedbackGetFeedbackAccessInformationReturn = ModFeedbackGetFeedbackAccessInformationReturns;
export type mod_feedback_get_feedback_access_information_returns = ModFeedbackGetFeedbackAccessInformationReturns;
