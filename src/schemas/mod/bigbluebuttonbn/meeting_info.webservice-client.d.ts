...
export interface ModBigbluebuttonbnMeetingInfoParams {
...
export interface ModBigbluebuttonbnMeetingInfoReturns {
    /** CM id */
    cmid: number | null;
    /** User limit */
...
export type ModBigbluebuttonbnMeetingInfoReturn = ModBigbluebuttonbnMeetingInfoReturns;
export type mod_bigbluebuttonbn_meeting_info_returns = ModBigbluebuttonbnMeetingInfoReturns;
