...
export interface ModScormGetScormsByCoursesParams {
    /** Array of course ids */
    courseids?: number | null[];
}

export interface ModScormGetScormsByCoursesReturns {
    scorms: Array<{
...
export type ModScormGetScormsByCoursesReturn = ModScormGetScormsByCoursesReturns;
export type mod_scorm_get_scorms_by_courses_returns = ModScormGetScormsByCoursesReturns;
