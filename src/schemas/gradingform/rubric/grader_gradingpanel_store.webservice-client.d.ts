...
export interface GradingformRubricGraderGradingpanelStoreParams {
...
export interface GradingformRubricGraderGradingpanelStoreReturns {
...
export type GradingformRubricGraderGradingpanelStoreReturn = GradingformRubricGraderGradingpanelStoreReturns;
export type gradingform_rubric_grader_gradingpanel_store_returns = GradingformRubricGraderGradingpanelStoreReturns;
