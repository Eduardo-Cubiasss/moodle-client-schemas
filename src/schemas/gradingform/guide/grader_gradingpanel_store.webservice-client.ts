...
export interface GradingformGuideGraderGradingpanelStoreParams {
...
export interface GradingformGuideGraderGradingpanelStoreReturns {
...
export type GradingformGuideGraderGradingpanelStoreReturn = GradingformGuideGraderGradingpanelStoreReturns;
export type gradingform_guide_grader_gradingpanel_store_returns = GradingformGuideGraderGradingpanelStoreReturns;
