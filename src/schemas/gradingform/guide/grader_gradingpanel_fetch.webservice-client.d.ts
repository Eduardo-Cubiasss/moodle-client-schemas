export interface GradingformGuideGraderGradingpanelFetchParams {
...
export interface GradingformGuideGraderGradingpanelFetchReturns {
...
export type GradingformGuideGraderGradingpanelFetchReturn = GradingformGuideGraderGradingpanelFetchReturns;
export type gradingform_guide_grader_gradingpanel_fetch_returns = GradingformGuideGraderGradingpanelFetchReturns;
